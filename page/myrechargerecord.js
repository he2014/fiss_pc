        ...
        'MAIN':'<div class="main">\
        		...
        		<div class="newAccountBox">\
					<div class="newAccountTab">\
						...
						<a href="/myrechargerecord.shtml" class="btnDef btnDefCur" data-i18n="PersonCenter_RechargeRecord">{{PersonCenter_RechargeRecord}}</a>\
                ...
                <div class="new_user_con">\
                    <div class="chz_date readStart">\
                        <label data-i18n="RechargeRecord_From" class="readStart">{{RechargeRecord_From}}</label>\
                        <input type="text"  class="Wdate readStart"  id="stime" data-stat="RechargeRecord_From" readonly="readonly"/>\
                        <label data-i18n="RechargeRecord_To" class="readStart">{{RechargeRecord_To}}</label>\
                            <input type="text"  class="Wdate readStart"  id="etime" data-stat="RechargeRecord_To" readonly="readonly"/>\
                        <input type="button" data-i18n="RechargeRecord_Query" data-stat="RechargeRecord_Query" id="checkR" class="btnDef btnDefOther readStart" value="{{RechargeRecord_Query}}"/>\
                    </div>\
                    <div class="cons_tab">\
        ...
        checkTimeSpanMonth:function(start, end, max_month) {
            ...
            if (max_month > 0) {
                ...
                if (m1 - m2 > max_month||m3 - m2 > max_month) {
                    $.tip_simple_alert(stringFormat(i18nTranslate('RechargeRecord_AtMostRecordCanBeRetrieved'),max_month));
                    return false;
                }
            }
            return true;
