            ...
            ملاحظة : توجد هناك فرصة أخيرة للمتسابقين الـ 9  الذين لم يحالفهم الحظ للصعود إلى الجولة الثالثة ، حيث سيتم إجراء مسابقة بينهم ، وسيتم اختيار شخصاً واحداً من بين الـ 9 المتسابقين ، وبهذا سيكون لدينا 10 من المتسابقين للجولة الثالثة .</span>\
                    ...
                    <div class="Main_Match">\
                        <div class="Page_Top">\
                            ...
                            <img src="/resource/static/image/2016School_Star_Match/Page_Top_Img_Third3.png" alt=""/>\
                            <div class="Activity_Produce ">\
                                <span class="Produces">\
                                    <h1 class="Produce_Title">مبروووك ! للفائزين الثلاثة في مسابقة نجم نجوم الجامعات</h1>\
                                    <span class="Produce_Details">\
                                        <a href="javascript:;"></a>\
                                    </span>\
                                </span>\
                                <span class="Activity_Time ">الجولة النهائية المرحلة الأخيرة  : 16/12/2016</span>\
                                <span class="Produce_1 hidden">1- سيتصدر من المرحلة الأولى 5 فائزين .</span>\
                                <span class="Produce_2 hidden">2- سيتصدر من المرحلة الأخيرة 3 فائزين ، مع جوائز قيمة و فرصة السفر إلى تركيا .</span>\
                                <span class="Produce_3 hidden">1- نتائج كل هذه المراحل يعتمد على عدد بطاقة التصويت <img src="/resource/static/image/2016School_Star_Match/Tickets_Img.png" alt=""/>الحاصل عليها المتسابق .</span>\
                            </div>\
                        </div>\
                ...
                function(data){
                    ...
                    if(data['code']==0){
                        ...
                        that.sMain=data.map(function(value,index,array){
                            ...
                            return stringFormat(TEMPLATE.Item,value['surfing'],sImg,sLive,sUsername,sLoaction,sSchool,sTopic,iNum,sRank);
                        }).join('');
                    }else{
